...
const SAVE_IDS: Readonly<Record<string, readonly string[]>> = {
  ...
  "tarstone-deadman-s-stone": ["Melee_Generic_CritChance"],
  ...
  "tarstone-scholar-s-wormstone": ["Melee_ClockworkGrinder", "Melee_WeaponAbility_ClockworkChainsaw"],
  ...
  "tarstone-warden-s-stone": ["Melee_InflictFrost", "Sidearm_QuickShooting"],
  "tarstone-weeping-stone": ["Sidearm_InflictTrauma"],
  "tarstone-wretchcaller-s-stone": ["Melee_InflictTrauma"],
  "tarstone-zealot-s-stone": ["Melee_LightAttackFinisher_Critical"],
};
