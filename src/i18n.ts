  ...
  fr: {
    translation: {
      ...
      checklist: {
        ...
        tarstoneIntro: "Le succès Minéralogiste compte 73 tarstones. Cette liste en a plus.",
        tarstoneNote: "L'import coche seulement les tarstones identifiés dans la save, pas toute la liste.",
        search: "Filtrer...",
  ...
  en: {
    translation: {
      ...
      checklist: {
        ...
        tarstoneIntro: "Stoned counts 73 tarstones. This list has extras.",
        tarstoneNote: "Save import only checks tarstones identified in the save, not the whole list.",
        search: "Filter...",
  ...
  es: {
    translation: {
      ...
      checklist: {
        ...
        tarstoneIntro: "El logro De piedra cuenta 73 tarstones. Esta lista tiene extras.",
        tarstoneNote: "La importación solo marca los tarstones identificados en la partida, no toda la lista.",
        search: "Filtrar...",
